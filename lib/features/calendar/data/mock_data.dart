...
class CalendarMockData {
  static List<CalendarEntry> getEntries() {
    return [
      ...
      CalendarEntry(
        id: '3',
        eventName: 'Spaghetti Bolognese',
        description: 'Nudeln mit Rinderhackfleisch',
      ...
      CalendarEntry(
        id: '4',
        eventName: "Pueri Gaudentes",
        description: 'Mittwoch, 4. März 2026',
        location: 'St. Cäcilia',
